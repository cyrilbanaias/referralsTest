...
@CucumberOptions(
		plugin = { "html:target/report/android", "json:target/json/android/reportAndroid.json"},
		strict = true,
 ...
 *
 */
public class TestAndroid extends Instantiation {
	private TestNGCucumberRunner testNGCucumberRunner;

	public static String classe = TestAndroid.class.getSimpleName();
	...
	public static void reportJson() throws Exception{
		...
		//}
		Files.copy(new File("target/json/android/reportAndroid.json"), new File(new File("target/json/"+xmlFiles)+"/"+"reportAndroid.json"));
	}
