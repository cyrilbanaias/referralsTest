 ...
 *
 */
public class TestEdge extends Instantiation {
	private TestNGCucumberRunner testNGCucumberRunner;

	public static String classe = TestEdge.class.getSimpleName();
	...
	public static void reportJson() throws Exception{
		...
		//}
		Files.copy(new File("target/json/edge/reportEdge.json"), new File(new File("target/json/"+xmlFiles)+"/"+"reportEdge.json"));
	}
