...
@CucumberOptions(
		plugin = { "html:target/report/ios", "json:target/json/ios/reportIOS.json"},
		strict = true,
 ...
 *
 */
public class TestIOS extends Instantiation {
	private TestNGCucumberRunner testNGCucumberRunner;

	public static String classe = TestIOS.class.getSimpleName();
	...
	public static void reportJson() throws Exception{
		...
		//}
		Files.copy(new File("target/json/ios/reportIOS.json"), new File(new File("target/json/"+xmlFiles)+"/"+"reportIOS.json"));
	}
