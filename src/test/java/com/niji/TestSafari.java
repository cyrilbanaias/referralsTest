...
@CucumberOptions(
		plugin = { "html:target/report/safari", "json:target/json/safari/reportSafari.json"},
		strict = true,
 ...
 * @author grageul
 */
public class TestSafari extends Instantiation {
	private TestNGCucumberRunner testNGCucumberRunner;

	public static String classe = TestSafari.class.getSimpleName();
	...
	public static void reportJson() throws Exception{
		...
		//}
		Files.copy(new File("target/json/safari/reportSafari.json"), new File(new File("target/json/"+xmlFiles)+"/"+"reportSafari.json"));
	}
